  ...
  http.get('*/api/v1/geographic-divisions', async () => {
    ...
    return HttpResponse.json({
      ...
      divisions: [
        ...
        // Leyte — Region VIII (Y2)
        { code: '08',         name: 'Region VIII (Eastern Visayas)',       type: 'region',       parentCode: null,        regionCode: '08', hasData: true },
        { code: '803700000',  name: 'Leyte',                              type: 'province',     parentCode: '08',        regionCode: '08', hasData: true },
        { code: 'LEY_VILLABA',name: 'Villaba',                            type: 'municipality', parentCode: '803700000', regionCode: '08', hasData: true },
        { code: 'LEY_PALO',   name: 'Palo',                               type: 'municipality', parentCode: '803700000', regionCode: '08', hasData: true },
        { code: 'LEY_TANAUAN',name: 'Tanauan',                            type: 'municipality', parentCode: '803700000', regionCode: '08', hasData: true },
        // Zamboanga del Norte — Region IX (Y2)
        { code: '09',                   name: 'Region IX (Zamboanga Peninsula)', type: 'region',       parentCode: null,        regionCode: '09', hasData: true },
        { code: '907200000',            name: 'Zamboanga del Norte',      type: 'province',     parentCode: '09',        regionCode: '09', hasData: true },
        { code: 'ZDN_SERGIO_OSMENA_SR', name: 'Sergio Osmena Sr.',        type: 'municipality', parentCode: '907200000', regionCode: '09', hasData: true },
        { code: 'ZDN_BACUNGAN',         name: 'Bacungan',                 type: 'municipality', parentCode: '907200000', regionCode: '09', hasData: true },
        { code: 'ZDN_SINDANGAN',        name: 'Sindangan',                type: 'municipality', parentCode: '907200000', regionCode: '09', hasData: true },
        // Davao del Sur — Region XI (Y2)
        { code: '11',            name: 'Region XI (Davao Region)',        type: 'region',       parentCode: null,         regionCode: '11', hasData: true },
        { code: '1102400000',    name: 'Davao del Sur',                   type: 'province',     parentCode: '11',         regionCode: '11', hasData: true },
        { code: 'DVS_MAGSAYSAY', name: 'Magsaysay',                       type: 'municipality', parentCode: '1102400000', regionCode: '11', hasData: true },
        { code: 'DVS_MATANAO',   name: 'Matanao',                         type: 'municipality', parentCode: '1102400000', regionCode: '11', hasData: true },
        { code: 'DVS_BANSALAN',  name: 'Bansalan',                        type: 'municipality', parentCode: '1102400000', regionCode: '11', hasData: true },
        { code: 'DVS_DIGOS_CITY',name: 'Digos City',                      type: 'municipality', parentCode: '1102400000', regionCode: '11', hasData: true },
        { code: 'DVS_SANTA_CRUZ',name: 'Santa Cruz',                      type: 'municipality', parentCode: '1102400000', regionCode: '11', hasData: true },
        // South Cotabato — Region XII (Y2)
        { code: '12',           name: 'Region XII (SOCCSKSARGEN)',        type: 'region',       parentCode: null,         regionCode: '12', hasData: true },
        { code: '1206300000',   name: 'South Cotabato',                   type: 'province',     parentCode: '12',         regionCode: '12', hasData: true },
        { code: 'SCO_LAKE_SEBU',name: 'Lake Sebu',                        type: 'municipality', parentCode: '1206300000', regionCode: '12', hasData: true },
        { code: 'SCO_T_BOLI',   name: 'T\'Boli',                          type: 'municipality', parentCode: '1206300000', regionCode: '12', hasData: true },
        { code: 'SCO_POLOMOLOK',name: 'Polomolok',                        type: 'municipality', parentCode: '1206300000', regionCode: '12', hasData: true },
        // Agusan del Norte — Region XIII / Caraga (Y2)
        { code: '16',            name: 'Region XIII (Caraga)',            type: 'region',       parentCode: null,         regionCode: '16', hasData: true },
        { code: '1600200000',    name: 'Agusan del Norte',               type: 'province',     parentCode: '16',         regionCode: '16', hasData: true },
        { code: 'AGN_KITCHARAO', name: 'Kitcharao',                       type: 'municipality', parentCode: '1600200000', regionCode: '16', hasData: true },
        { code: 'AGN_NASIPIT',   name: 'Nasipit',                         type: 'municipality', parentCode: '1600200000', regionCode: '16', hasData: true },
        { code: 'AGN_BUENAVISTA',name: 'Buenavista',                      type: 'municipality', parentCode: '1600200000', regionCode: '16', hasData: true },
      ],
    })
  }),
  ...
  http.get('*/api/v1/public/geographic/divisions', async () => {
    ...
    return HttpResponse.json({
      ...
      divisions: [
        ...
        // Leyte — Region VIII (Y2)
        { code: '08',         name: 'Region VIII (Eastern Visayas)',       type: 'region',       parentCode: null,        regionCode: '08' },
        { code: '803700000',  name: 'Leyte',                              type: 'province',     parentCode: '08',        regionCode: '08' },
        { code: 'LEY_VILLABA',name: 'Villaba',                            type: 'municipality', parentCode: '803700000', regionCode: '08' },
        { code: 'LEY_PALO',   name: 'Palo',                               type: 'municipality', parentCode: '803700000', regionCode: '08' },
        { code: 'LEY_TANAUAN',name: 'Tanauan',                            type: 'municipality', parentCode: '803700000', regionCode: '08' },
        // Zamboanga del Norte — Region IX (Y2)
        { code: '09',                   name: 'Region IX (Zamboanga Peninsula)', type: 'region',       parentCode: null,        regionCode: '09' },
        { code: '907200000',            name: 'Zamboanga del Norte',      type: 'province',     parentCode: '09',        regionCode: '09' },
        { code: 'ZDN_SERGIO_OSMENA_SR', name: 'Sergio Osmena Sr.',        type: 'municipality', parentCode: '907200000', regionCode: '09' },
        { code: 'ZDN_BACUNGAN',         name: 'Bacungan',                 type: 'municipality', parentCode: '907200000', regionCode: '09' },
        { code: 'ZDN_SINDANGAN',        name: 'Sindangan',                type: 'municipality', parentCode: '907200000', regionCode: '09' },
        // Davao del Sur — Region XI (Y2)
        { code: '11',            name: 'Region XI (Davao Region)',        type: 'region',       parentCode: null,         regionCode: '11' },
        { code: '1102400000',    name: 'Davao del Sur',                   type: 'province',     parentCode: '11',         regionCode: '11' },
        { code: 'DVS_MAGSAYSAY', name: 'Magsaysay',                       type: 'municipality', parentCode: '1102400000', regionCode: '11' },
        { code: 'DVS_MATANAO',   name: 'Matanao',                         type: 'municipality', parentCode: '1102400000', regionCode: '11' },
        { code: 'DVS_BANSALAN',  name: 'Bansalan',                        type: 'municipality', parentCode: '1102400000', regionCode: '11' },
        { code: 'DVS_DIGOS_CITY',name: 'Digos City',                      type: 'municipality', parentCode: '1102400000', regionCode: '11' },
        { code: 'DVS_SANTA_CRUZ',name: 'Santa Cruz',                      type: 'municipality', parentCode: '1102400000', regionCode: '11' },
        // South Cotabato — Region XII (Y2)
        { code: '12',           name: 'Region XII (SOCCSKSARGEN)',        type: 'region',       parentCode: null,         regionCode: '12' },
        { code: '1206300000',   name: 'South Cotabato',                   type: 'province',     parentCode: '12',         regionCode: '12' },
        { code: 'SCO_LAKE_SEBU',name: 'Lake Sebu',                        type: 'municipality', parentCode: '1206300000', regionCode: '12' },
        { code: 'SCO_T_BOLI',   name: 'T\'Boli',                          type: 'municipality', parentCode: '1206300000', regionCode: '12' },
        { code: 'SCO_POLOMOLOK',name: 'Polomolok',                        type: 'municipality', parentCode: '1206300000', regionCode: '12' },
        // Agusan del Norte — Region XIII / Caraga (Y2)
        { code: '16',            name: 'Region XIII (Caraga)',            type: 'region',       parentCode: null,         regionCode: '16' },
        { code: '1600200000',    name: 'Agusan del Norte',               type: 'province',     parentCode: '16',         regionCode: '16' },
        { code: 'AGN_KITCHARAO', name: 'Kitcharao',                       type: 'municipality', parentCode: '1600200000', regionCode: '16' },
        { code: 'AGN_NASIPIT',   name: 'Nasipit',                         type: 'municipality', parentCode: '1600200000', regionCode: '16' },
        { code: 'AGN_BUENAVISTA',name: 'Buenavista',                      type: 'municipality', parentCode: '1600200000', regionCode: '16' },
      ],
    })
  }),
